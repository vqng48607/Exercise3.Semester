...
namespace MusicStore.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        {
            var musicStoreContext = _context.Album.Include(a => a.Artist).Include(a => a.Genre).Include(a => a.Songs);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var album = await _context.Album.Include(a => a.Songs).FirstOrDefaultAsync(x => x.AlbumId == id);
            if (album == null)
            {
                return NotFound();
            }
